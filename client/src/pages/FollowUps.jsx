...
function getAvatarColor(scoreLabel) {
  if (scoreLabel === 'hot') return 'bg-red-500';
  if (scoreLabel === 'warm') return 'bg-amber-400';
  return 'bg-slate-400';
}
    ...
    <div className="space-y-6">
      ...
      {leads.length > 0 && (
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="relative overflow-hidden rounded-lg p-5 bg-slate-600 text-white cursor-default">
            <div className="flex items-center gap-2 mb-1">
      ...
      {filtered.length === 0 ? (
        ...
        <div className="space-y-3">
          {filtered.map((lead, index) => {
            ...
            const avatarColor = getAvatarColor(lead.score_label);
              ...
              >
                <div className="flex items-center gap-4 px-5 py-4">
                  ...
                  <div className="relative flex-shrink-0">
                    <div className={`w-11 h-11 ${avatarColor} rounded-lg flex items-center justify-center text-xs font-bold text-white`}>
                      {initials}
                    </div>
